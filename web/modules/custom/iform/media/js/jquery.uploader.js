...
jQuery.fn.uploader.defaults = {
  ...
  file_box_initial_link_infoTemplate:
  `<div id="link-{linkRequestId}" class="ui-widget-content ui-corner-all link">
    <div class="ui-widget-header ui-corner-all ui-helper-clearfix">
      <span id="link-title-{linkRequestId}">Loading...</span>
      <span class="delete-file fas fa-trash-alt" id="del-{id}"></span></div>
    <div id="link-embed-{linkRequestId}"></div>
  </div>`,
  file_box_initial_file_infoTemplate:
  `<div id="{id}" class="mediafile">
    <div class="media-file-header">
      <span>{filename}</span>
      <span class="delete-file fas fa-trash-alt" id="del-{id}" title="Remove this file"></span>
    </div>
    <div class="progress-wrapper">
      <progress class="progress" value="0" max="100">0 %</progress>
      <div class="progress-percent"></div>
      <div class="progress-gif"></div>
    </div>
