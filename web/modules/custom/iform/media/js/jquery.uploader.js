...
jQuery.fn.uploader.defaults = {
  ...
  file_box_initial_file_infoTemplate : '<div id="{id}" class="ui-widget-content ui-corner-all mediafile"><div class="header ui-widget-header ui-corner-all ui-helper-clearfix"><span>{filename}</span> ' +
